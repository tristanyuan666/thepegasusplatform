            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              <div className="glass-premium p-4 sm:p-8 hover-lift">
                <div className="bg-white rounded-2xl p-4 sm:p-8 border border-gray-200 shadow-sm">
                  ...
                  <button 
                    className="w-full bg-gradient-to-r from-gray-900 to-gray-800 text-white py-4 px-6 rounded-xl font-medium hover:shadow-lg transition-transform duration-300 hover:scale-105 will-change-transform"
              ...
              <div className="glass-premium p-4 sm:p-8 hover-lift">
                <div className="bg-white rounded-2xl p-4 sm:p-8 border border-gray-200 shadow-sm">
                  ...
                  <button 
                    className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white py-4 px-6 rounded-xl font-medium hover:shadow-lg transition-transform duration-300 hover:scale-105 will-change-transform mt-6"
                    onClick={handleFeatureClick}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
            {[
              ...
              >
                ...
                <button className="w-full bg-gradient-to-r from-gray-900 to-gray-800 text-white py-3 px-6 rounded-xl font-medium hover:shadow-lg transition-transform duration-300 group-hover:scale-105 will-change-transform">
                  {feature.demo}
                </button>
              </div>
            ))}
