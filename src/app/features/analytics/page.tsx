...
import { BarChart3, ArrowRight, TrendingUp, Eye, Users } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Monitor your follower growth, engagement rates, and content
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Understand which content performs best and optimize your
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get detailed demographics and behavior insights about your
