...
export default function MobileNavigation({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-1 py-0.5 md:hidden z-50">
        ...
        {navigationItems.map((item) => {
          ...
          if (!hasAccess) {
            return (
              ...
              >
                ...
                <span className="text-[9px] font-medium text-gray-400 leading-tight">{item.name}</span>
              </div>
            );
          }
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center gap-0 p-0.5 rounded-lg transition-colors hover-target interactive-element",
                isActive
