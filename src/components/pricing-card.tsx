      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 md:gap-4 mb-3 md:mb-6">
            ...
            <div>
              <h3 className="text-xs md:text-2xl font-bold text-gray-900 group-hover:text-blue-600 transition-all duration-300">
                {safePlan.name}
              </h3>
              <p className="text-gray-600 text-[8px] md:text-sm">{safePlan.description}</p>
            </div>
          </div>
