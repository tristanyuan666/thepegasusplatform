      ...
      <Card className="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700 text-white">
        <CardContent className="p-4 md:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h1 className="text-[10px] md:text-2xl font-bold mb-0.5 md:mb-2 flex items-center gap-1 md:gap-2">
                <User className="w-2.5 h-2.5 md:w-6 md:h-6" />
                Welcome back, {userProfile?.full_name || userProfile?.name || "Creator"}!
              </h1>
              <p className="text-blue-100 flex items-center gap-1 md:gap-2 text-[8px] md:text-base">
